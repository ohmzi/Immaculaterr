...
export function FunSplitSlider(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'absolute top-0 left-0 h-full overflow-hidden shadow-[4px_0_24px_rgba(0,0,0,0.5)] z-10',
          pct >= maxPct ? 'rounded-2xl' : 'rounded-l-2xl',
        )}
        style={{
          width: `${pct}%`,
      ...
      <div
        className={cn(
          'absolute top-0 right-0 h-full overflow-hidden shadow-[-4px_0_24px_rgba(0,0,0,0.5)] z-10',
          pct <= minPct ? 'rounded-2xl' : 'rounded-r-2xl',
        )}
        style={{
          left: `${pct}%`,
          transition: isDragging
