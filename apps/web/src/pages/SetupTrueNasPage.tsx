        ...
        <div className="container mx-auto px-4 pb-20 max-w-5xl">
          <div className="mb-12">
            ...
            >
              ...
              <p className="text-sky-100/70 text-lg font-medium max-w-3xl leading-relaxed ml-1">
                End-to-end TrueNAS SCALE setup for Immaculaterr with HTTP + HTTPS sidecar,
                trusted local certificate, and secure secret transport.
              </p>
          ...
          <div className="space-y-6">
            <div className={cardClass}>
              <h2 className="text-white font-semibold text-2xl">1) Create the main app</h2>
              ...
              {renderCodeBlock('truenas-main-app-yaml', 'yaml', TRUENAS_MAIN_APP_YAML)}
            </div>

            <div className={cardClass}>
              <h2 className="text-white font-semibold text-2xl">2) Create the HTTPS sidecar app</h2>
              <p className="mt-2 text-sm text-white/70 leading-relaxed">
            ...
            <div className={cardClass}>
              <h2 className="text-white font-semibold text-2xl">3) Add hostname mapping on clients</h2>
              <p className="mt-2 text-sm text-white/70 leading-relaxed">
            ...
            <div className={cardClass}>
              <h2 className="text-white font-semibold text-2xl">4) Collect the local CA certificate</h2>
              <p className="mt-2 text-sm text-white/70 leading-relaxed">
            ...
            <div className={cardClass}>
              <h2 className="text-white font-semibold text-2xl">
                5) Install the certificate on Ubuntu clients
              </h2>
              <p className="mt-2 text-sm text-white/70 leading-relaxed">
            ...
            <div className={cardClass}>
              <h2 className="text-white font-semibold text-2xl">6) Verify HTTPS</h2>
              <p className="mt-2 text-sm text-white/70 leading-relaxed">
